...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.newItemButton.setGeometry(QRect(440, 80, 75, 24))
        self.pushButton_1 = QPushButton(self.centralwidget)
        self.pushButton_1.setObjectName(u"pushButton_1")
        self.pushButton_1.setGeometry(QRect(210, 690, 101, 24))
        self.pushButton_2 = QPushButton(self.centralwidget)
        self.pushButton_2.setObjectName(u"pushButton_2")
        self.pushButton_2.setGeometry(QRect(360, 690, 75, 24))
        self.pushButton_4 = QPushButton(self.centralwidget)
        self.pushButton_4.setObjectName(u"pushButton_4")
        self.pushButton_4.setGeometry(QRect(620, 690, 75, 24))
        self.pushButton_5 = QPushButton(self.centralwidget)
        self.pushButton_5.setObjectName(u"pushButton_5")
        self.pushButton_5.setGeometry(QRect(760, 690, 75, 24))
        self.pushButton_3 = QPushButton(self.centralwidget)
        self.pushButton_3.setObjectName(u"pushButton_3")
        self.pushButton_3.setGeometry(QRect(480, 690, 75, 24))
        self.deleteItemPushButton = QPushButton(self.centralwidget)
        self.deleteItemPushButton.setObjectName(u"deleteItemPushButton")
        self.deleteItemPushButton.setGeometry(QRect(630, 80, 75, 24))
        self.loadDataPushButton = QPushButton(self.centralwidget)
        self.loadDataPushButton.setObjectName(u"loadDataPushButton")
        self.loadDataPushButton.setGeometry(QRect(240, 80, 75, 24))
        self.open_excel_file_PushButton = QPushButton(self.centralwidget)
        self.open_excel_file_PushButton.setObjectName(u"open_excel_file_PushButton")
        self.open_excel_file_PushButton.setGeometry(QRect(820, 80, 75, 24))
...
"\uff08s\uff09", None));
        ...
        self.open_excel_file_PushButton.setText(QCoreApplication.translate("MainWindow", u"\u6253\u5f00\u6d41\u7a0b\u8868", None))
    # retranslateUi
