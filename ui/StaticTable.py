...
class Ui_StaticTable(object):
    def setupUi(self, StaticTable):
        ...
        self.pushButton_3.setGeometry(QRect(170, 190, 75, 24))
        self.pushButton_4 = QPushButton(StaticTable)
        self.pushButton_4.setObjectName(u"pushButton_4")
        self.pushButton_4.setGeometry(QRect(260, 190, 75, 24))
        self.widget = QWidget(StaticTable)
        self.widget.setObjectName(u"widget")
        self.widget.setGeometry(QRect(29, 36, 191, 26))
