...
################################################################################
## Form generated from reading UI file 'sample2.ui'
##
...
class Ui_Sample2(object):
    def setupUi(self, Sample2):
        if not Sample2.objectName():
            Sample2.setObjectName(u"Sample2")
        Sample2.resize(797, 687)
        self.label = QLabel(Sample2)
        self.label.setObjectName(u"label")
        self.label.setGeometry(QRect(330, 10, 101, 31))
        self.label_2 = QLabel(Sample2)
        self.label_2.setObjectName(u"label_2")
        self.label_2.setGeometry(QRect(50, 80, 121, 21))
        self.runModeComboBox = QComboBox(Sample2)
        ...
        self.hexLineEdit_1 = QLineEdit(Sample2)
        ...
        self.hexLineEdit_2 = QLineEdit(Sample2)
        ...
        self.hexOmitLineEdit_2 = QLineEdit(Sample2)
        ...
        self.hexLineEdit_3 = QLineEdit(Sample2)
        ...
        self.hexOmitLineEdit_3 = QLineEdit(Sample2)
        ...
        self.hexLineEdit_4 = QLineEdit(Sample2)
        ...
        self.hexOmitLineEdit_4 = QLineEdit(Sample2)
        ...
        self.hexLineEdit_5 = QLineEdit(Sample2)
        ...
        self.hexOmitLineEdit_5 = QLineEdit(Sample2)
        ...
        self.hexLineEdit_6 = QLineEdit(Sample2)
        ...
        self.hexOmitLineEdit_6 = QLineEdit(Sample2)
        ...
        self.hexLineEdit_7 = QLineEdit(Sample2)
        ...
        self.hexOmitLineEdit_7 = QLineEdit(Sample2)
        ...
        self.label_11 = QLabel(Sample2)
        self.label_11.setObjectName(u"label_11")
        self.label_11.setGeometry(QRect(50, 570, 54, 16))
        self.actionIDLineEdit = QLineEdit(Sample2)
        ...
        self.groupBox_2 = QGroupBox(Sample2)
        ...
        self.groupBox_3 = QGroupBox(Sample2)
        ...
        self.retranslateUi(Sample2)

        QMetaObject.connectSlotsByName(Sample2)
    # setupUi

    def retranslateUi(self, Sample2):
        Sample2.setWindowTitle(QCoreApplication.translate("Sample2", u"Dialog", None))
        self.label.setText(QCoreApplication.translate("Sample2", u"3\u6837\u63d0\u673a2\u53c2\u6570\u8bbe\u7f6e", None))
        self.label_2.setText(QCoreApplication.translate("Sample2", u"\u6837\u63d0\u673a2\u8fd0\u884c\u65b9\u5f0f\u8bbe\u7f6e", None))
        self.runModeComboBox.setItemText(0, QCoreApplication.translate("Sample2", u"\u5f00\u73af", None))
        self.runModeComboBox.setItemText(1, QCoreApplication.translate("Sample2", u"\u9650\u4f4d\u5f00\u5173", None))
        self.runModeComboBox.setItemText(2, QCoreApplication.translate("Sample2", u"\u7f16\u7801\u5668", None))

        self.label_3.setText(QCoreApplication.translate("Sample2", u"\u6837\u63d0\u673a2\u8fd0\u884c\u5f00\u73af\u8bbe\u7f6e\u503c", None))
        self.valLineEdit_1.setText(QCoreApplication.translate("Sample2", u"10", None))
        self.label_4.setText(QCoreApplication.translate("Sample2", u"\u6837\u63d0\u673a2\u8fd0\u884c\u7f16\u7801\u5668\u8bbe\u7f6e\u503c", None))
        self.valLineEdit_2.setText(QCoreApplication.translate("Sample2", u"1", None))
        self.valLineEdit_3.setText(QCoreApplication.translate("Sample2", u"2", None))
        self.label_5.setText(QCoreApplication.translate("Sample2", u"\u6837\u63d0\u673a2\u8109\u51b2\u8f93\u51fa\u9608\u503c", None))
        self.valLineEdit_4.setText(QCoreApplication.translate("Sample2", u"2", None))
        self.label_6.setText(QCoreApplication.translate("Sample2", u"\u6837\u63d0\u673a2\u7eed\u8f6c\u6b65\u6570", None))
        self.label_7.setText(QCoreApplication.translate("Sample2", u"\u9650\u4f4d\u5f00\u5173\u8bbe\u7f6e\u503c", None))
        self.switchValComboBox.setItemText(0, QCoreApplication.translate("Sample2", u"\u63d0\u673a2\u4e0a\u9650", None))
        self.switchValComboBox.setItemText(1, QCoreApplication.translate("Sample2", u"\u63d0\u673a2\u4e0b\u9650", None))
        self.switchValComboBox.setItemText(2, QCoreApplication.translate("Sample2", u"\u8f6c\u673a1\u96f6", None))
        self.switchValComboBox.setItemText(3, QCoreApplication.translate("Sample2", u"\u8f6c\u673a1\u8ba1", None))
        self.switchValComboBox.setItemText(4, QCoreApplication.translate("Sample2", u"5\u53f7", None))
        self.switchValComboBox.setItemText(5, QCoreApplication.translate("Sample2", u"6\u53f7", None))
        self.switchValComboBox.setItemText(6, QCoreApplication.translate("Sample2", u"\u7089\u4e0a\u673a3\u4e0a\u9650", None))
        self.switchValComboBox.setItemText(7, QCoreApplication.translate("Sample2", u"\u7089\u4e0a\u673a3\u4e0b\u9650", None))
        self.switchValComboBox.setItemText(8, QCoreApplication.translate("Sample2", u"\u7089\u4e0b\u673a5\u4e0a\u9650", None))
        self.switchValComboBox.setItemText(9, QCoreApplication.translate("Sample2", u"\u7089\u4e0b\u673a5\u4e0b\u9650", None))
        self.switchValComboBox.setItemText(10, QCoreApplication.translate("Sample2", u"\u4e0d\u4f7f\u7528", None))

        self.label_8.setText(QCoreApplication.translate("Sample2", u"\u5931\u6b65\u9608\u503c", None))
        self.valLineEdit_5.setText(QCoreApplication.translate("Sample2", u"10", None))
        self.label_9.setText(QCoreApplication.translate("Sample2", u"\u5341\u516d\u8fdb\u5236\u7f29\u5199", None))
        self.label_10.setText(QCoreApplication.translate("Sample2", u"\u5341\u516d\u8fdb\u5236", None))
        ...
        self.label_11.setText(QCoreApplication.translate("Sample2", u"\u52a8\u4f5cID", None))
        self.actionIDLineEdit.setText("")
        self.generateIDPushButton.setText(QCoreApplication.translate("Sample2", u"\u751f\u6210\u52a8\u4f5cID", None))
        self.commitPushButton.setText(QCoreApplication.translate("Sample2", u"\u786e\u5b9a", None))
        self.cancelPushButton.setText(QCoreApplication.translate("Sample2", u"\u53d6\u6d88", None))
        self.groupBox.setTitle(QCoreApplication.translate("Sample2", u"\u5f00\u73af\u53c2\u6570", None))
        self.label_12.setText(QCoreApplication.translate("Sample2", u"P", None))
        self.label_13.setText(QCoreApplication.translate("Sample2", u"i", None))
        self.label_14.setText(QCoreApplication.translate("Sample2", u"z1", None))
        self.label_15.setText(QCoreApplication.translate("Sample2", u"z2", None))
        self.label_16.setText(QCoreApplication.translate("Sample2", u"\u8fd0\u52a8\u7c7b\u522b", None))
        self.typeComboBox_1.setItemText(0, QCoreApplication.translate("Sample2", u"\u76f4\u7ebf\u8fd0\u52a8", None))
        self.typeComboBox_1.setItemText(1, QCoreApplication.translate("Sample2", u"\u5706\u5468\u8fd0\u52a8", None))

        self.groupBox_2.setTitle(QCoreApplication.translate("Sample2", u"\u975e\u5f00\u73af\u53c2\u6570", None))
        self.label_17.setText(QCoreApplication.translate("Sample2", u"P", None))
        self.label_18.setText(QCoreApplication.translate("Sample2", u"i", None))
        self.label_19.setText(QCoreApplication.translate("Sample2", u"z1", None))
        self.label_20.setText(QCoreApplication.translate("Sample2", u"z2", None))
        self.label_21.setText(QCoreApplication.translate("Sample2", u"\u8fd0\u52a8\u7c7b\u522b", None))
        self.typeComboBox_2.setItemText(0, QCoreApplication.translate("Sample2", u"\u76f4\u7ebf\u8fd0\u52a8", None))
        self.typeComboBox_2.setItemText(1, QCoreApplication.translate("Sample2", u"\u5706\u5468\u8fd0\u52a8", None))

        self.groupBox_3.setTitle(QCoreApplication.translate("Sample2", u"\u9650\u4f4d\u5f00\u5173\u6709\u6548\u53c2\u6570", None))
        self.label_22.setText(QCoreApplication.translate("Sample2", u"P", None))
        self.label_23.setText(QCoreApplication.translate("Sample2", u"i", None))
        self.label_24.setText(QCoreApplication.translate("Sample2", u"z1", None))
        self.label_25.setText(QCoreApplication.translate("Sample2", u"z2", None))
        self.label_26.setText(QCoreApplication.translate("Sample2", u"\u8fd0\u52a8\u7c7b\u522b", None))
        self.typeComboBox_3.setItemText(0, QCoreApplication.translate("Sample2", u"\u76f4\u7ebf\u8fd0\u52a8", None))
        self.typeComboBox_3.setItemText(1, QCoreApplication.translate("Sample2", u"\u5706\u5468\u8fd0\u52a8", None))
